...
import type { IBlockPropertySelect } from "~core/types";
...
const model = defineModel<IBlockPropertySelect["value"]>();
</script>

<template>
  <UISelectLabel :for="id">
    {{ field.label }}
  </UISelectLabel>
  <UIRichSelect.Root v-model="model">
